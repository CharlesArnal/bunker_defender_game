...
# Installation
Download every file and folder, put everything in the same folder, and open "Starting_page_OPEN_ME" with a Google Chrome (other browsers tend to cause problems).
